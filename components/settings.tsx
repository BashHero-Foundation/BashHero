            ...
            >
                ...
                <div
                    className="
                        w-40 h-full
                        bg-bg-body
                        border-l border-border-separator
                        shadow-2xl
                    "
                >
